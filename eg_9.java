...
public class EG_9 {
  ...
  public static void contar_usuarios(String[][] matriz, int cantidad){
    int menorA26, menorA35, mayorA35;
    menorA26 = 0;
    menorA35 = 0;
    mayorA35 = 0;
    for (int i = 0; i < cantidad; i++) {
      if (Integer.parseInt(matriz[i][2]) <= 25) menorA26++;
      else if (Integer.parseInt(matriz[i][2]) <= 35) menorA35++;
      else mayorA35++;
    }
    System.out.println("La cantidad de asistentes menores de 26 años son: " + menorA26);
    System.out.println("La cantidad de asistentes entre 26 y 35 años son: " + menorA35);
    System.out.println("La cantidad de asistentes mayores a 35 años son: " + mayorA35);
  }
  public static String[][] rellena_asistentes(String[][] matriz, String nombre_capacitacion, String asistentes) {
    ...
    for (int i = 0; i < cantidad; i++) {
        ...
        matriz[i][2] = ingresar_num_noVacio("Ingresa la edad del asistente");
    }
    return matriz;
  }
}
